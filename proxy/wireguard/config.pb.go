...
type DeviceConfig struct {
	...
	Parameters     *AmneziaParameters          `protobuf:"bytes,10,opt,name=parameters,proto3" json:"parameters,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *DeviceConfig) GetParameters() *AmneziaParameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
const file_proxy_wireguard_config_proto_rawDesc = "" +
	...
	"\x02i5\x18\x10 \x01(\tR\x02i5\"\xa5\x04\n" +
	...
	"\rno_kernel_tun\x18\t \x01(\bR\vnoKernelTun\x12G\n" +
	"\n" +
	"parameters\x18\n" +
	" \x01(\v2'.xray.proxy.wireguard.AmneziaParametersR\n" +
	"parameters\"\\\n" +
...
var file_proxy_wireguard_config_proto_depIdxs = []int32{
	...
	2, // 3: xray.proxy.wireguard.DeviceConfig.parameters:type_name -> xray.proxy.wireguard.AmneziaParameters
